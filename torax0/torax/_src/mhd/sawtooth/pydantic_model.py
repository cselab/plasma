...
class SawtoothConfig(torax_pydantic.BaseModelFrozen):
    ...
    def build_models(self):
        return sawtooth_models.SawtoothModels(
            ...
            build_redistribution_model(),
        )

    def build_runtime_params(
            self, t: chex.Numeric) -> sawtooth_runtime_params.RuntimeParams:
        return sawtooth_runtime_params.RuntimeParams(
            ...
            redistribution_params=self.redistribution_model.
            build_runtime_params(t),
        )
